...
public class Comment_Test extends BaseTest {
	 ...
	 * // 数据驱动登录测试
	 * 
	 * @Test(dataProvider = "WP_user", dataProviderClass = NSDataProvider.class)
	 * public void LoginSuccess(String name, String password) throws Exception {
	 * webtest.open("http://localhost:8032/wordpress/wp-login.php?");
	 * action.login(name, password); assertTrue(webtest.ifContains("仪表盘"));
	 * 
	 * }
	 */
...
//		action.login("yty", "12345678");
	...
	public void change_commit() {
		...
		webtest.click(
				"xpath=//a[@href='http://localhost:8032/wordpress/wp-admin/comment.php?action=editcomment&c=24']");
//				webtest.click("xpath=//label[text()='待审']");

		// webtest.click("xpath=//textarea[@id='content']");

		webtest.typeAndClear("xpath=//textarea[@id='content']", "这本书很好看，我和爸爸都很喜欢");
